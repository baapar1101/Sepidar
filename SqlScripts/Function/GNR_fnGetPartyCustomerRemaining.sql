IF OBJECT_ID('GNR.fnGetPartyCustomerRemaining') IS NOT NULL
	DROP FUNCTION [GNR].[fnGetPartyCustomerRemaining]
GO

CREATE FUNCTION [GNR].[fnGetPartyCustomerRemaining] (@PartyDLRef INT = -1, @ContainsCheque INT = 1, @FiscalYearRef INT, @FromDate DATE = NULL, @ToDate DATE = NULL)
RETURNS TABLE
