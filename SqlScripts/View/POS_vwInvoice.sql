If Object_ID('POS.vwInvoice') Is Not Null
	Drop View POS.vwInvoice
GO
Create VIEW [POS].[vwInvoice]
AS
SELECT     I.InvoiceId, C.Title CashierTitle , CashierRef ,C.PartyRef CustomerPartyRef, C.PartyFullName AS CustomerPartyFullName, ST.Title AS SaleTypeTitle, 
