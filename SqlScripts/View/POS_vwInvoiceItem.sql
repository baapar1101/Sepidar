If Object_ID('POS.vwInvoiceItem') Is Not Null
	Drop View POS.vwInvoiceItem
GO
Create VIEW [POS].[vwInvoiceItem]
AS
SELECT     II.InvoiceItemID, II.InvoiceRef, II.RowID, II.ItemRef, I.Type AS ItemType, I.TaxExempt ItemTaxExempt ,
...
FROM				  POS.InvoiceItem II INNER JOIN  
					  POS.Invoice INV ON INV.InvoiceID = II.InvoiceRef LEFT JOIN  
